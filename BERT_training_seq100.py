...
import sys
sys.path.append("/home/bks/tmp/pycharm_project_994/")
...
# 配置bert模型参数
config = {}
config["train_corpus_path"] = "/home/bks/tmp/pycharm_project_994/dataset/pretrain_data.txt"
config["test_corpus_path"] = "/home/bks/tmp/pycharm_project_994/dataset/pretrain_data/pretrain_data_test.txt"
config["word2idx_path"] = "/home/bks/tmp/pycharm_project_994/croups/ident_base.pickle"
config["output_path"] = "/home/bks/tmp/pycharm_project_994/output_model"  # 模型输出位置
...
config["model_out_path"] = config["output_path"] + "/" + "small_hidden_" + str(config["hidden_size"]) \
                            + "_layers_" + str(config["num_hidden_layers"]) + "_heads_" + str(config["num_attention_heads"])+"/seq100/"
...
class Pretrainer:
    ...
    def save_state_dict(self, model, epoch, dir_path="/home/bks/tmp/pycharm_project_994/output_model", file_path="bert.model"):
...
if __name__ == '__main__':
    def init_trainer(dynamic_lr, load_model=True):
